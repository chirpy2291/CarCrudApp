...
public class Cars {
	...
	public Cars(int carid,
			@Size(min = 2, message = "Name should have atleast 2 characters") @NotEmpty(message = "Name cannot be empty") @NotNull(message = "Car Name cannot be null") String carname,
			double price, String model, Integer yearOfManufacture, String fuelType) {
		super();
		this.carid = carid;
